...
class BulkUpdateVisionImagesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'okr.vision_images.bulk.PUT';
    }

    public function getDescription(): string
    {
        return 'PUT /okr/vision_images/bulk - Aktualisiert mehrere Zielbilder in einem Request.';
    }
        ...
        return [
            ...
            'properties' => [
                ...
                'updates' => [
                    ...
                    'items' => [
                        'type' => 'object',
                        'properties' => ['id' => ['type' => 'integer'], 'title' => ['type' => 'string'], 'description' => ['type' => 'string'], 'order' => ['type' => 'integer']],
                        'required' => ['id'],
                    ],
                ],
            ],
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $singleTool = new UpdateVisionImageTool();
            ...
            return ToolResult::error('EXECUTION_ERROR', 'Fehler beim Bulk-Update der Zielbilder: ' . $e->getMessage());
        }
    }

    public function getMetadata(): array
    {
        return ['category' => 'bulk', 'tags' => ['okr', 'vision_images', 'bulk', 'batch', 'update'], 'read_only' => false, 'requires_auth' => true, 'requires_team' => false, 'risk_level' => 'medium', 'idempotent' => false];
    }
}
