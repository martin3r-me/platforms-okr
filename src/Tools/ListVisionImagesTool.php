...
class ListVisionImagesTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'okr.vision_images.GET';
    }

    public function getDescription(): string
    {
        return 'GET /okr/vision_images?focus_area_id={id}&filters=[...]&search=... - Listet Zielbilder auf. WICHTIG: focus_area_id ist erforderlich (Zielbilder gehören zu einem Fokusraum).';
    }
        ...
        return $this->mergeSchemas(
            ...
            [
                'properties' => [
                    'focus_area_id' => [
                        'type' => 'integer',
                        'description' => 'FocusArea-ID (required). Zielbilder sind immer focus_area-bezogen.',
                    ],
                ],
