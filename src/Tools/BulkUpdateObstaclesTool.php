...
class BulkUpdateObstaclesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'okr.obstacles.bulk.PUT';
    }

    public function getDescription(): string
    {
        return 'PUT /okr/obstacles/bulk - Aktualisiert mehrere Hindernisse in einem Request.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $singleTool = new UpdateObstacleTool();
            ...
            return ToolResult::error('EXECUTION_ERROR', 'Fehler beim Bulk-Update der Hindernisse: ' . $e->getMessage());
        }
    }

    public function getMetadata(): array
    {
        return ['category' => 'bulk', 'tags' => ['okr', 'obstacles', 'bulk', 'batch', 'update'], 'read_only' => false, 'requires_auth' => true, 'requires_team' => false, 'risk_level' => 'medium', 'idempotent' => false];
    }
}
