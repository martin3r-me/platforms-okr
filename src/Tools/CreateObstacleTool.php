...
class CreateObstacleTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'okr.obstacles.POST';
    }

    public function getDescription(): string
    {
        return 'POST /okr/obstacles - Erstellt ein Hindernis. WICHTIG: focus_area_id ist erforderlich (Hindernisse gehören zu einem Fokusraum).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            if ($order === null) {
                $max = Obstacle::where('focus_area_id', $focusAreaId)->max('order');
                $order = ($max ?? 0) + 1;
            }
            ...
            return ToolResult::success([
                ...
                'message' => 'Hindernis erfolgreich erstellt.',
            ]);
        } catch (\Throwable $e) {
            return ToolResult::error('EXECUTION_ERROR', 'Fehler beim Erstellen des Hindernisses: ' . $e->getMessage());
        }
    }
