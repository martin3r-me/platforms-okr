...
class CycleObjectivesManagement extends Component
{
    use WithPagination;
    ...
    {
        $this->cycle = $cycle;
        $this->cycle->load(['okr', 'objectives.keyResults']);
    }
    ...
    public function manageObjectiveKeyResults($objectiveId)
    {
        ...
        return redirect()->route('okr.objectives.key-results.index', ['objective' => $objectiveId]);
    }
    ...
    {
        return view('okr::livewire.cycle-objectives-management')
